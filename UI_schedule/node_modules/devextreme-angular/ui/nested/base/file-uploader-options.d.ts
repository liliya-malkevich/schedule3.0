...
export declare abstract class DxoFileUploaderOptions extends NestedOption {
    ...
    get onBeforeSend(): Function;
    set onBeforeSend(value: Function);
    get onContentReady(): Function;
    set onContentReady(value: Function);
    get onDisposing(): Function;
    set onDisposing(value: Function);
    get onDropZoneEnter(): Function;
    set onDropZoneEnter(value: Function);
    get onDropZoneLeave(): Function;
    set onDropZoneLeave(value: Function);
    get onFilesUploaded(): Function;
    set onFilesUploaded(value: Function);
    ...
    set onProgress(value: Function);
    get onUploadAborted(): Function;
    set onUploadAborted(value: Function);
    get onUploaded(): Function;
    set onUploaded(value: Function);
    get onUploadError(): Function;
    set onUploadError(value: Function);
    get onUploadStarted(): Function;
    set onUploadStarted(value: Function);
