 ...
 */
class DxNavBarComponent extends DxComponent {
...
/** @nocollapse */ DxNavBarComponent.ɵcmp = /** @pureOrBreakMyCode */ i0.ɵɵdefineComponent({ type: DxNavBarComponent, selectors: [["dx-nav-bar"]], contentQueries: function DxNavBarComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ]), i0.ɵɵInheritDefinitionFeature, i0.ɵɵNgOnChangesFeature], decls: 0, vars: 0, template: function DxNavBarComponent_Template(rf, ctx) { }, encapsulation: 2 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DxNavBarComponent, [{
        type: Component,
        args: [{
                selector: 'dx-nav-bar',
                template: '',
...
class DxNavBarModule {
}
/** @nocollapse */ DxNavBarModule.ɵfac = function DxNavBarModule_Factory(t) { return new (t || DxNavBarModule)(); };
/** @nocollapse */ DxNavBarModule.ɵmod = /** @pureOrBreakMyCode */ i0.ɵɵdefineNgModule({ type: DxNavBarModule });
/** @nocollapse */ DxNavBarModule.ɵinj = /** @pureOrBreakMyCode */ i0.ɵɵdefineInjector({ imports: [[
            DxiItemModule,
            DxIntegrationModule,
            DxTemplateModule,
        ...
        DxTemplateModule] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DxNavBarModule, [{
        type: NgModule,
        args: [{
                imports: [
                    DxiItemModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(DxNavBarModule, { declarations: [DxNavBarComponent], imports: [DxiItemModule,
        DxIntegrationModule,
        DxTemplateModule,
        BrowserTransferStateModule], exports: [DxNavBarComponent, DxiItemModule,
        DxTemplateModule] }); })();
